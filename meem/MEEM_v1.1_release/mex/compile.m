...
% set the values
opts.opencv_include_path    =   'D:\Program Files (x86)\opencv2.4.13\opencv\build\include'; % OpenCV include path
opts.opencv_lib_path        =   'D:\Program Files (x86)\opencv2.4.13\opencv\build\x64\vc12\lib'; % OpenCV lib path
