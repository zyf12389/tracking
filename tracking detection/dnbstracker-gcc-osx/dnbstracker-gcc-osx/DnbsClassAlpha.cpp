// DnbsClassAlpha.cpp
// Implementation of 'DnbsClassAlpha' class.
//
...
DnbsClassAlpha::DnbsClassAlpha(void)
{
}
...
void DnbsClassAlpha::computeNBS(int MaxNumBases,
                                   ...
                                   double coherence)
{
    ...
    naivenbs.computeNBS(MaxNumBases);
...
void DnbsClassAlpha::sample_backgrounds(CvRect rect,
                                      int MaxNumBackgrounds,
                                      int distance_threshold,
                                      int x_min, int x_max,
                                      int y_min, int y_max,
...
void DnbsClassAlpha::updateNBS(int MaxNumBases,
							   int MaxNumForegrounds,
                                  int MaxNumBackgrounds,
                                  IplImage * frame,
                                  CvRect rect,
...
void DnbsClassAlpha::computeDNBS_v1(
  int MaxNumBases,
  double lambda,
  vector<CvMat*> foreground,
  vector<CvMat*> background)
...
void DnbsClassAlpha::computeDNBS_v2(
                                 int MaxNumBases,
                                 IplImage * frame,
                                 double lambda,
                                 vector< CvRect > & samples)
...
void DnbsClassAlpha::computeCoeffMatrix(int K) {
...
double DnbsClassAlpha::reconerr(void) {
...
void DnbsClassAlpha::computeNBS_discriminant(
	int MaxNumBases,
	IplImage * frame,
	CvRect rect,
	double lambda,
