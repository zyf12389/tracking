...
im1=imread('C:\Users\zyf\Desktop\photo\1\first_resize.jpg');
im2=imread('C:\Users\zyf\Desktop\photo\1\warpImg.jpg');
...
clear flow;
flow(:,:,1)=vx;
flow(:,:,2)=vy; figure;imshow(flowToColor(flow));title('SIFT flow field');
